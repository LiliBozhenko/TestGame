...
public class MainMenu : MonoBehaviour
{
    ...
    public void ShopShipHighlighting()
    {
        ...
        for (int i = 0; i < DataBase.instance.playerShipsInfo.Length; i++)
        {
            ...
            if (DataBase.instance.playerShipsInfo[i][1] == 0)
                shop_Ship_Text[i].text = "Открыт";
            else
                shop_Ship_Text[i].text = "Цена: " + DataBase.instance.playerShipsInfo[i][1].ToString();
        }
    }
    ...
    public void ShopCheckPlayerShip(int num)
    {
            ...
            DataBase.instance.playerShipsInfo[num][1] <= DataBase.instance.Score)
        {
            ...
            shop_Btn_Buy_Cost_Text.text = "Купить " + DataBase.instance.playerShipsInfo[num][1].ToString();
    ...
    public void UpgradesGetInformation()
    {
        ...
        // Show update cost HP
        upgrade_Show_Cost[0].text = "Цена: " + DataBase.instance.costHP.ToString();
        // Show update cost Speed
        upgrade_Show_Cost[1].text = "Цена: " + DataBase.instance.costSpeed.ToString();
        // Show update cost Shield
        upgrade_Show_Cost[2].text = "Цена: " + DataBase.instance.costShield.ToString();
